...
INSERT INTO `customers` (`userid`, `password`) VALUES
    ("admin", "admin");

-- select * from content where type = 'post' and deleted is null ORDER BY published desc;
-- SELECT COUNT(1) AS count FROM content;
